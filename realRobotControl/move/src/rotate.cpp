...
pos1b = msg->current_pos;
	if ((pos1b - prevPos1b < 0.03) || (pos1b - prevPos1b > -0.03)){
		isMoving = 0;
	}
...
ros::Publisher pub6 = stuck.advertise<std_msgs::Int64>("/isStuck", 100);
...
if ((pos1 - pos1b > 0.03) || (pos1 - pos1b < -0.03)){
	goalPos = 1;
}

if ((pos1 - pos1b < 0.03 && msg.data - pos1b > 0) || (pos1 - pos1b > -0.03 && pos1 - pos1b < 0)){
	goalPos = 0;
}
...
if (isMoving == 0 && goalPos == 1){
 st.data = 1;
}else{
st.data = 0;
}
pub6.publish(st);
ROS_INFO("isMoving ? %d  goalpos = %d  ", isMoving, goalPos);
